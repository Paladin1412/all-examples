...
class SchNums(object):
    ...
    def _log(self, spider):
        logging.info('scrapy_cnt,project={},spider={} sch_nums={},item_nums={},spider_error_nums={},item_error_nums={}'.format(PROJECT_NAME, spider.name, self.sch_nums, self.item_nums,
